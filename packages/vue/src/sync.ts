...
import type { NativeNavigationVueView } from './types'
 ...
 */
export function initSync(views: Record<ComponentId, NativeNavigationVueView>): void {
	/*
	 ...
	 * to other windows.
	 * <p>
	 * Vue may use insertRule for CSS-in-JS solutions or dynamic styling.
	 */
