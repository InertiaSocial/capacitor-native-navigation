# Capacitor Native Navigation Vue Example App

This Vue example includes web, iOS and Android projects to test with while developing and evaluating Capacitor Native Navigation with Vue 3 and Vue Router 4.
